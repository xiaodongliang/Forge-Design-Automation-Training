...
namespace MyTestDesignAutomation
{
    class VariousOuputs
    {
        static public void VariousOuputsMain()
        {
            //获取Token
            ...
            CreateOneActivityWithPackage_OutputToZip(container, myAct_with_Pack_Name, myAppPackName);
        ...
        //创建某关联AppPackage的Activity,并导出结果为zip
        static Activity CreateOneActivityWithPackage_OutputToZip(Container container,
                                                    string actId,
                                                    string appPackName)
        {
            ...
            var activity = new Activity()
            {
                ...
                Instruction = new Instruction()
                {
                    ...
                    //测试导出压缩包
                    Script = "MyPluginCommand outputs\n"
                },
                Parameters = new Parameters()
                {
                    ...
                    {                     
                       //测试导出压缩包
                       Name = "Result", LocalFileName = "outputs"
                    }
                  }
                },
                RequiredEngineVersion = "21.0"
